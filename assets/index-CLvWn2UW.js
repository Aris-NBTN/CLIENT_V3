import{r as B,H as Ve,bH as Le,t as re,I as W,A as ye,y as ie,P as Ee,j as A,bj as ce,bi as de}from"./index-Bl_pZCeN.js";import{f as be}from"./fileApi-B1MZT04M.js";import{R as me,C as q}from"./row-BAzrWk1M.js";import{S as $}from"./context-CeT_YlOn.js";var we={exports:{}},ae={};/**
 * @license React
  ...
  .`.concat(c,`cell70 {
    width: 70%;
      ...
      `).concat(g?`<style>
          `.concat(v,`
          `).concat(k,`
        </style>`):"")})),M("column2")&&p.add("column2",a(a({},P),{label:t.labelColumn2,media:`<svg viewBox="0 0 23 24">
      ...
      `).concat(g?`<style>
          `.concat(v,`
          `).concat(k,`
        </style>`):"")})),M("column3")&&p.add("column3",a(a({},P),{label:t.labelColumn3,media:`<svg viewBox="0 0 23 24">
      ...
      `).concat(g?`<style>
          `.concat(v,`
          `).concat(k,`
        </style>`):"")})),M("column3-7")&&p.add("column3-7",a(a({},P),{label:t.labelColumn37,media:`<svg viewBox="0 0 24 24">
        ...
        <div `).concat(O," style='").concat(d?"flex-basis":"width",`: 30%;'></div>
        <div `).concat(O," style='").concat(d?"flex-basis":"width",`: 70%;'></div>
      </div>
      `).concat(g?`<style>
          `.concat(v,`
          `).concat(k,`
